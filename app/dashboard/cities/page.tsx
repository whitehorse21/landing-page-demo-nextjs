    ...
    <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                title={t('dashboard.browseCities.gridView')}
                className="shrink-0"
              >
                <svg
                  className="w-5 h-5"
              ...
              <Button
                ...
                title={t('dashboard.browseCities.listView')}
                className="shrink-0"
              >
                <svg
                  className="w-5 h-5"
      ...
      {viewMode === 'grid' ? (
        ...
        <div className="space-y-4">
          {displayedCities.map((city) => (
            <Card key={city.id} className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer h-48">
              <div className="flex h-full">
                <div className="relative w-full sm:w-64 h-full bg-gray-200 dark:bg-gray-700 shrink-0">
                  <img 
                    src={city.image} 
                    alt={city.name} 
                    className="w-full h-full object-cover"
                ...
                <CardContent className="p-4 flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between h-full">
