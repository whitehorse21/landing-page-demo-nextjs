    ...
    >
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
        ...
        <a
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors mt-2"
          aria-label="GitHub"
        >
